...
public class DbHandler extends SQLiteOpenHelper {
    ...
    public static final String TABLICA_PROJEKT = "Projekt";
    public static final String TABLICA_PROJEKT_TMP = "ProjektTmp";
    ...
    public void addProjekt(Projekt projekt)
    {
        ...
        cv.put(Col4Projekt, projekt.getDatPocetka().getTime());
        cv.put(Col4Projekt, projekt.getDatZavrsetka().getTime());
        db.insert(TABLICA_PROJEKT_TMP, null, cv);
        db.close();
    }

    public Cursor readAllFromTableProjekt(){
        SQLiteDatabase db=this.getReadableDatabase();
        Cursor cursor=db.rawQuery("SELECT SifProjekta, NazProjekta, OpisProjekta, DatPocetka, " +
                        "DatZavrsetka FROM " + TABLICA_PROJEKT_TMP,
                new String[]{});
        return cursor;
    }
    ...
    public void addUlogaOsobe(UlogaOsobe ulogaOsobe)
    {
        SQLiteDatabase db=this.getWritableDatabase();
        ContentValues cv=new ContentValues();
